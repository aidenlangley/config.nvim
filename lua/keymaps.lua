...
nmap("<Leader>Q", cmd("q!"), "Force quit")
...
-- Buffers
wk_register("<Leader>b", "Buffers...")
nmap("<Leader>bd", cmd("bd"), "Close")
nmap("<Leader>bn", cmd("enew"), "New")
nmap("<Leader>bq", cmd("%bd|e#|bd#"), "Close all")
nmap("<Leader>bb", telescope("buffers"), "Find")
